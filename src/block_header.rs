...
use crate::guesser_receiver_data::GuesserReceiverData;
use crate::mast_hash::HasDiscriminant;
use crate::mast_hash::MastHash;
...
pub type BlockPow = Pow<{ crate::pow::POW_MEMORY_TREE_HEIGHT }>;
