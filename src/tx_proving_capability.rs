...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, Default, GetSize)]
...
impl TxProvingCapability {
    pub fn can_prove(&self, proof_type: TransactionProofType) -> bool {
...
mod generated_tests {
    ...
    pub mod nc {
        pub use neptune_cash::api::export::TxProvingCapability;
    }
